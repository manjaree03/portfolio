...
function loadHomePage(){
    ...
    let count = 0;
    const style = getSelectedMockupStyle(); // laptop-minimal | browser
    ...
    filteredProjects.forEach((project, idx) => {
        ...
        const imageUrl = (project.images && project.images.length > 0)
          ? normalizeAssetPath(project.images[0])
          : normalizeAssetPath(project.thumbnail);
        imgArea.appendChild(createMockupNode(style, imageUrl, project.name));
...
function renderProjects(filteredProjects) {
    ...
    filteredProjects.forEach((project, idx) => {
        ...
        const imageUrl = (project.images && project.images.length > 0) ? project.images[0] : project.thumbnail;
        imgArea.appendChild(createMockupNode(style, imageUrl, project.name));
